...
- หากใช้งานผ่านสมาร์ตโฟน: หน้าจอรองรับ mobile layout และ input แบบปุ่มกด/แป้นพิมพ์มือถือ
...
#### A5 – เครือข่ายมือถือไม่เสถียรระหว่างบันทึก

- 8a. พนักงานกดบันทึกแล้ว request timeout หรือ offline  
- 8b. ระบบบันทึกข้อมูลลง local queue พร้อมสถานะ `รอส่ง`  
- 8c. เมื่อเชื่อมต่อได้ ระบบ retry อัตโนมัติและแจ้งผลให้พนักงาน  
- 8d. หาก retry ไม่สำเร็จเกินจำนวนที่กำหนด ให้แสดงปุ่ม `ลองส่งอีกครั้ง`
...
- หากใช้มือถือสแกน: ผู้ใช้ต้องอนุญาตสิทธิ์กล้อง หรือมี fallback ให้กรอกรหัสแทน
...
#### B5 – ไม่ได้รับสิทธิ์กล้องบนสมาร์ตโฟน

- 3a. ผู้ใช้ปฏิเสธการเข้าถึงกล้อง หรือ browser ไม่รองรับ  
- 3b. ระบบแสดง fallback input ให้กรอก `shipment_id` หรือ `awb_number`  
- 3c. พนักงานค้นหารายการด้วยรหัสแทนการสแกน แล้วทำข้อ 7–14 ต่อได้ตามปกติ
