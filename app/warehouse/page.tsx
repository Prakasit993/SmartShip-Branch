            ...
            <div className="mx-auto max-w-2xl px-4 py-10 sm:px-6 sm:py-14">
                ...
                <div className="mb-10 space-y-2">
                    <div className="flex items-center gap-3">
                        <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl bg-amber-500/15 text-2xl ring-1 ring-amber-500/25">
                            📦
                        </div>
                        <div>
                ...
                {/* Upload card */}
                <div className="rounded-2xl border border-slate-800/80 bg-slate-900/50 p-6 shadow-xl shadow-black/30 ring-1 ring-white/[0.04]">
