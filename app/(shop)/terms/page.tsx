...
export default function TermsPage() {
    ...
    return (
        <PolicyLayout
            breadcrumb={language === 'th' ? 'ข้อกำหนดและเงื่อนไข' : 'Terms of Service'}
            labTag="// TERMS.V1"
            title={language === 'th' ? 'ข้อกำหนดและเงื่อนไข' : 'Terms of Service'}
            lastUpdated={language === 'th' ? `อัปเดตล่าสุด: ${lastUpdated}` : `Last updated: ${lastUpdated}`}
            lead={
                language === 'th'
                    ? 'เงื่อนไขการใช้บริการเว็บไซต์ NYXEL — กรุณาอ่านก่อนสั่งซื้อ การใช้บริการถือเป็นการยอมรับข้อกำหนดเหล่านี้'
                    : 'Terms governing your use of NYXEL services. Please read before placing an order — using our services means you accept these terms.'
            }
            versionMark="TERMS · V.1 · 2026.01"
                ...
                {language === 'th' ? (
                    <>
                        <section className="mb-8">
                            ...
                            <p className="text-zinc-600 dark:text-zinc-400 leading-relaxed">
                                การใช้บริการเว็บไซต์ NYXEL ถือว่าคุณยอมรับและตกลงที่จะปฏิบัติตามข้อกำหนดและเงื่อนไขเหล่านี้ หากคุณไม่เห็นด้วยกับข้อกำหนดใดๆ กรุณาหยุดใช้บริการ
                            </p>
                        </section>
                        ...
                        <section className="mb-8">
                            ...
                            <ul className="list-disc list-inside text-zinc-600 dark:text-zinc-400 space-y-2">
                                <li>ระยะเวลาจัดส่งโดยประมาณ 1-3 วันทำการ ผ่าน J&T Express</li>
                        ...
                        <section className="mb-8">
                            ...
                            <p className="text-zinc-600 dark:text-zinc-400 leading-relaxed">
                                เนื้อหา รูปภาพ โลโก้ NYXEL และทรัพย์สินทางปัญญาทั้งหมดบนเว็บไซต์นี้เป็นของ NYXEL ห้ามคัดลอก ดัดแปลง หรือนำไปใช้โดยไม่ได้รับอนุญาตเป็นลายลักษณ์อักษร
                            </p>
                        </section>
                    ...
                    <>
                        <section className="mb-8">
                            ...
                            <p className="text-zinc-600 dark:text-zinc-400 leading-relaxed">
                                By using the NYXEL website, you agree to comply with and be bound by these Terms of Service. If you do not agree to any terms, please stop using our services.
                            </p>
                        </section>
                        ...
                        <section className="mb-8">
                            ...
                            <ul className="list-disc list-inside text-zinc-600 dark:text-zinc-400 space-y-2">
                                <li>Estimated delivery time is 1-3 business days via J&T Express</li>
                        ...
                        <section className="mb-8">
                            ...
                            <p className="text-zinc-600 dark:text-zinc-400 leading-relaxed">
                                All content, images, NYXEL logos, and intellectual property on this website belong to NYXEL. Copying, modifying, or using without written permission is prohibited.
                            </p>
                        </section>
